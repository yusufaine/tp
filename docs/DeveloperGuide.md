...
1. Adding a new recipe
    ...
    1. Test case: `add -n Recipename1 -d 5 -ss 2 -i Ingredient1 | Ingredient2 | Ingredient3 -s Step 1 | Step 2 | Step 3 -t Tag1 | Tag2 | Tag3`<br>
    ...
    1. Test case: `add -n Recipename1 -d 5 -ss 2 -i Ingredient1 | Ingredient2 | Ingredient3`<br>
       Expected: No recipe is added due to missing recipe steps. Valid command details are shown in the error message.

    1. Other incorrect delete commands to try: `add -n`, `add`, `add -ss`, `add -d`, `add -s Step2` <br>
...
1. Editing a new recipe
    ...
    1. Test case: `edit -x 1 -n Recipename1 -d 5 -ss 2 -i Ingredient1 | Ingredient2 | Ingredient3 -s Step 1 | Step 2 | Step 3`<br>
    ...
    1. Test case: `edit -n Recipename1 -d 5 -ss 2 -i Ingredient1 | Ingredient2 | Ingredient3 -s Step 1 | Step 2 | Step 3`<br>
       Expected: No recipe is edited due to missing recipe index. Error details shown in the status message.

    1. Other incorrect delete commands to try: `edit 1`, `edit -x 1`, `edit -x 1 -ss`, `edit -x 1 -d` <br>
