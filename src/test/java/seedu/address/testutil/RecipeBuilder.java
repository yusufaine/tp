...
public class RecipeBuilder {
    ...
    /**
     * Parses the {@code ingredients} into a {@code ArrayList<Ingredient>} and set it to the {@code Recipe} that we are
     * building.
     */
    public RecipeBuilder withIngredients(String ... steps) {
        this.ingredients = SampleDataUtil.getIngredientList(steps);
        return this;
    }
